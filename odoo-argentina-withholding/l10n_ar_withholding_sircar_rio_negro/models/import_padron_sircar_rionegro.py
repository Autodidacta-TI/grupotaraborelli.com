...
class ImportPadronSircarRioNegro(models.Model):
    _name = 'import.padron.sircar.rionegro'
    _description = 'import.padron.sircar.rionegro'
        ...
        for i,line in enumerate(lines):
            ...
            if len(lista) > 10:
                ...
                if tipo == 'P' or tipo == 'R': 
                    ...
                    padron_existe = self.env['sircar.rionegro.padron'].search([('name','=',cuit)])
                    if len(padron_existe) > 0:
                        ...
                        self.env['sircar.rionegro.padron'].sudo().create(vals)
                    _procesados += "{} \n".format(cuit)
