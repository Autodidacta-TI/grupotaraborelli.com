...
class AccountPaymentGroupInherit(models.Model):
    ...
    def compute_withholdings(self):
        ...
        for rec in self:
            ...
            if len(rec.partner_id.alicuot_ret_sircar_rionegro_ids) > 0:
                retencion = rec.partner_id.alicuot_ret_sircar_rionegro_ids.filtered(lambda l: l.padron_activo == True)[0]
                ...
                _imp_ret = self.env['account.tax'].search([
                    ...
                    ('tax_sircar_rionegro_ret','=',True)], limit=1)
                ...
                rec.payment_ids = [(0,0, {
                    ...
                    'tax_withholding_id': _imp_ret.id,
                    'payment_method_description': 'Retencion IIBB SIRCAR Rio Negro',
